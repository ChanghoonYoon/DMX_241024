...
led_t updateStandbyVals(led_t currentVals){
    ...
    if(r == 50 && g < 50 && b == 0){
        currentVals.g++;
    } else if(g == 50 && r > 0 && b == 0){
        currentVals.r--;
    } else if(g == 50 && b < 50 && r == 0){
        currentVals.b++;
    } else if(b == 50 && g > 0 && r == 0){
        currentVals.g--;
    } else if(b == 50 && r < 50 && g == 0){
        currentVals.r++;
    } else if(r == 50 && b > 0 && g == 0){
        currentVals.b--;
    } else{
        currentVals.r = 0;
        currentVals.g = 0;
...
led_t standbyLed = {.r = 50, .g = 0, .b = 0};
void standby(void){
    uint8_t index = 0;
    static uint8_t standby_delay_counter = 0;
    static led_t standbyVals[7] = {
        {.r = 50, .g = 0, .b =0},
        {.r = 50, .g = (uint8_t)(50*.85),.b = 0},
        {.r = (uint8_t)(50*.275), .g = 50, .b = 0},
        {.r = 0, .g = (uint8_t)50, .b = (uint8_t)(50*.57)},
        {.r = 0, .g = (uint8_t)(50*.57),.b = 50},
        {.r = (uint8_t)(50*.275), .g = 0, .b = 50},
        {.r = 50, .g = 0, .b = (uint8_t)(50*.85)},
    };
